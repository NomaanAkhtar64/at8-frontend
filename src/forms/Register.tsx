                        ...
                        {newTeam === "null" && (
                            <div className="register-team-btns">
                                <div className="register-option-heading">
                                    <h2>
                                        Select how you want to register your
                                        team
                                    </h2>
                                </div>
                                    ...
                                    <div className="register-form">
                                        ...
                                        <form
                                            ...
                                            onSubmit={async (e) => {
                                                ...
                                                const imgBase64 = await imgToBase64(
                                                    logo
                                                );
